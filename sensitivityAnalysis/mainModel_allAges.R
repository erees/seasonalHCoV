...
#' Using alpha to change the FOI in old
#' FOI ~ Normal(0.3,0.5)
#' Cutoff ~ Uniform(0,20)
#' Alpha ~ gamm(5,0.2)
#' Waning ~ Uniform(0,5)
#' Sensitvity analysis using all dat (<1 year)
...
datComb <- readRDS("dataProcessing/cleanedDataAllAges.RDS")
...
jmod = jags.model(textConnection(jcode), data=jdat, n.chains=4, n.adapt=40000)
update(jmod)
