...
lambdaShao_22 ~ dnorm(0.5,1)
lambdaZhou_22 ~ dnorm(0.5,1)
lambdaCav ~ dnorm(0.5,1)
lambdaChan ~ dnorm(0.5,1)
lambdaZhou_hk ~ dnorm(0.5,1)
lambdaZhou_oc ~ dnorm(0.5,1)
lambdaMonto ~ dnorm(0.5,1)
lambdaSar ~ dnorm(0.5,1)
lambdaZhou_nl ~ dnorm(0.5,1)
lambdaShao_nl ~ dnorm(0.5,1)
